...
public class MyBatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("myTestDbDataSource") DataSource myTestDbDataSource,
        ...
        targetDataSources.put(DatabaseType.databases, myTestDbDataSource);
        targetDataSources.put(DatabaseType.databases2, myTestDb2DataSource);
  ...
  /*  *//**
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("myTestDbDataSource") DataSource myTestDbDataSource,
        ...
        fb.setTypeAliasesPackage(environment.getProperty("com.dao"));
        fb.setMapperLocations(resolver.getResources("classpath:com/dao/mapper/**/*.xml"));
        return fb.getObject();
    }
